...
''',
    exports: const [KlDisplay],
    directives: const [KlBox])
class TesterBox {
  @ViewChild('attrDisplay')
  ElementRef attrDisplayRef;
  @ViewChild('ngAttrDisplay')
  ElementRef ngAttrDisplayRef;
  @ViewChild('dirDisplay')
  ElementRef dirDisplayRef;
  @ViewChild('styleDisplay')
  ElementRef styleDisplayRef;

  @ViewChild('dirConstraint')
  ElementRef dirConstraintRef;

  @ViewChild('dirDecoration')
  ElementRef dirDecorationRef;

  @ViewChild('dirPadding')
  ElementRef dirPaddingRef;

  @ViewChild('dirMargin')
  ElementRef dirMarginRef;

  Element get attrDisplay => attrDisplayRef.nativeElement;

  Element get ngAttrDisplay => ngAttrDisplayRef.nativeElement;

  Element get styleDisplay => styleDisplayRef.nativeElement;

  Element get dirDisplay => dirDisplayRef.nativeElement;

  Element get dirConstraint => dirConstraintRef.nativeElement;

  Element get dirDecoration => dirDecorationRef.nativeElement;

  Element get dirPadding => dirPaddingRef.nativeElement;

  Element get dirMargin => dirMarginRef.nativeElement;
