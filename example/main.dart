...
import 'package:kl/src/directives/image.dart';

@Component(
  selector: 'my-app',
  templateUrl: 'app_component.html',
  styleUrls: const ['app_component.css'],
  directives: const [KlContainer, KlColumn, KlRow, KlText, KlImage, KlFlexible],
)
class AppComponent {
  KlConstraint fixedWidthAndHeight = new KlConstraint(width: "100px", height: "100px");
  ...
  KlConstraint messageConstraint = new KlConstraint(height: "100px");
  ...
  KlJustifyContent justifyContent = KlJustifyContent.spaceEvenly;
}
